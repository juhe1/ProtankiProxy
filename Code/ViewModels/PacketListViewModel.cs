	...
	public class PacketListViewModel
	{
		...
		public PacketListViewModel()
		{
			TreeDataGridSource = new FlatTreeDataGridSource<PacketListItem>(FilteredPackets)
			{
				Columns =
				{
					new TextColumn<PacketListItem, DateTime>(
						"Time",
						x => x.Timestamp,
						width: new Avalonia.Controls.GridLength(130)
					),
					new TextColumn<PacketListItem, string>(
						"Source",
						x => x.Source,
						width: new Avalonia.Controls.GridLength(130)
					),
					...
					new TextColumn<PacketListItem, int>(
						"Size",
						x => x.Size,
						width: new Avalonia.Controls.GridLength(120)
					),
				},
			};
		}
